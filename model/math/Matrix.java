...
public class Matrix {
    ...
    public static Matrix getIdentityMatrix(int dimensions) { // initializes a matrix with 1.0 on the main diagonal
    ...
    public static Matrix getIdentityMatrix() { // initializes a matrix with 1.0 on the main diagonal
    ...
    public Matrix inverse() { // TODO error handling : assert nRows == nColumns
