...
public class Vec3f extends Vector {
    ...
    public Vec3f(float[] data) { // TODO assigning raw values to their type here is probably redundant
    ...
    public Vec3f(Matrix m) { // divide by homogenous coordinate
        super(m.getElement(0, 0) / m.getElement(3, 0), m.getElement(1, 0) / m.getElement(3, 0),
                m.getElement(2, 0) / m.getElement(3, 0));
        raw[0] = raw[0].floatValue();
        raw[1] = raw[1].floatValue();
        raw[2] = raw[2].floatValue();
    }
